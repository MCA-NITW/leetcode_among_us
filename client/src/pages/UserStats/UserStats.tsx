                              ...
                              {userData.contestHistory
                                ...
                                .map((contest, index) => {
                                  ...
                                  const ratingChange = contest.attended
                                    ...
                                    : 0
                                  const trendEmojiMap: Record<string, string> =
                                    { UP: '📈', DOWN: '📉' }
                                  const trendEmoji =
                                    trendEmojiMap[
                ...
                <div className="user-stats__card user-stats__card--wide">
                  ...
                  <div className="user-stats__card-content">
                    <div className="user-stats__info-item">
                      ...
                      <span className="user-stats__info-value user-stats__info-value--success">
                        {(userData.totalEasy ?? 0) > 0
                          ? (
                              ((userData.easySolved ?? 0) /
                                (userData.totalEasy ?? 1)) *
                              100
                            ).toFixed(1)
                          : '0'}
                        %
                    ...
                    <div className="user-stats__info-item">
                      ...
                      <span className="user-stats__info-value">
                        {(userData.totalMedium ?? 0) > 0
                          ? (
                              ((userData.mediumSolved ?? 0) /
                                (userData.totalMedium ?? 1)) *
                              100
                            ).toFixed(1)
                          : '0'}
                        %
                    ...
                    <div className="user-stats__info-item">
                      ...
                      <span className="user-stats__info-value">
                        {(userData.totalHard ?? 0) > 0
                          ? (
                              ((userData.hardSolved ?? 0) /
                                (userData.totalHard ?? 1)) *
                              100
                            ).toFixed(1)
                          : '0'}
                        %
                        ...
                        <div className="user-stats__star-icons">
                          {Array.from({ length: 5 }, (_, i) => i + 1).map(
                            starNum => (
                              <span
                                key={`star-${starNum}`}
                                className={`user-stats__star-icon ${starNum <= Math.floor(userData.starRating!) ? 'user-stats__star-icon--filled' : ''}`}
                              >
                                <FaStar />
                              </span>
                            )
