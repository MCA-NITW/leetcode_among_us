...
interface UserDifficultyData {
  easySolved?: number
  mediumSolved?: number
  hardSolved?: number
}

interface DifficultyGroupedBarProps {
  user1Data?: UserDifficultyData
  user2Data?: UserDifficultyData
  user1Name?: string
  user2Name?: string
}
 ...
 */
function DifficultyGroupedBar({
  user1Data,
  user2Data,
  user1Name,
  user2Name
}: DifficultyGroupedBarProps) {
