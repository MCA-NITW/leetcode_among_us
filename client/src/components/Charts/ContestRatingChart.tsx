 ...
 */
function ContestRatingChart({ contestHistory = [] }: ContestRatingChartProps) {
  ...
  const attended = useMemo(() => {
    return contestHistory
      .filter(c => c.attended && c.contest?.startTime)
      ...
      datasets: [
        {
          ...
          backgroundColor: (ctx: ScriptableContext<'line'>) => {
            ...
            gradient.addColorStop(1, hexToRgba(colors.contest, 0))
            return gradient
          },
          fill: true,
          tension: 0.3,
